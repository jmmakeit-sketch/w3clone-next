                  ...
                  {Object.entries(strand.subStrands).map(([subKey, sub]) => (
                    ...
                    >
                      <div className="flex flex-col pr-4">
                        <span className="text-xs font-semibold text-slate-700 group-hover:text-blue-900 transition-colors">{sub.title}</span>
                        <span className="text-[10px] text-slate-400 mt-0.5 truncate max-w-[280px] sm:max-w-md">Inquiry: {sub.inquiryQuestion}</span>
                      </div>
                      <span className="text-[10px] font-bold text-slate-500 bg-white border px-2 py-0.5 rounded shrink-0 group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 transition-all shadow-2xs">{sub.lessons}P</span>
                    </Link>
                  ))}
                </div>
              </div>
