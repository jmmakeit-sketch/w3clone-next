...
export default function Grade4AgricultureDashboard() {
  ...
  // Calculate runtime aggregates from the data maps
                ...
                <div className="grid gap-1.5">
                  {Object.entries(strand.subStrands).map(([subKey, sub]) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-bold text-slate-500 bg-white border px-2 py-0.5 rounded shrink-0 group-hover:bg-emerald-600 group-hover:text-white group-hover:border-emerald-600 transition-all shadow-2xs">
                        {sub.lessons}P
                      </span>
                    </Link>
                  ))}
