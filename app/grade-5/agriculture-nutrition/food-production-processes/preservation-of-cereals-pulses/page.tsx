...
export default function PreservationOfCerealsPulsesDynamic() {
  const data = grade5AgriNutritionContent["food-production-processes"].subStrands["preservation-of-cereals-pulses"];
