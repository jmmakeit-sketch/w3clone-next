...
export default function UsesOfDomesticAnimalsDynamic() {
  const data = grade5AgriNutritionContent["food-production-processes"].subStrands["uses-of-domestic-animals"];
